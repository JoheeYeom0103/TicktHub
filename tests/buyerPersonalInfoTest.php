...
require_once "php/buyerPersonalInfo.php";

class BuyerPersonalInfoTest extends TestCase
{
    ...
    /* Test form submission with sample data set */
    public function testFormSubmission()
    {
        ...
        $_POST['submit'] = true; // to simulate submission
        ...
        ob_start();
        // This includes your action script that handles the POST request
        include "app/PersonalInfo_Action.php"; 
        $output = ob_get_clean();
