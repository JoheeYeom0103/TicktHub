...
<div id="container">
   ...
   <?php
    ...
    <!-- Place order buttons -->
    <div id="place-order">
        <button type="button" id="order-selected"><a href="payment.php?TotalCost=<?php echo urlencode($totalCost); ?>" style="text-decoration: none; color: white;">Order Selected</a></button>
        <button type="button"><a href="payment.php?TotalCost=<?php echo urlencode($totalCost); ?>" style="text-decoration: none; color: white;">Order All</a></button>
    </div>
</div>
